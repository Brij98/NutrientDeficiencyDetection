...
def main():
    leaf_data = pd.read_csv("D:/leafimages/Normal_leaf_features.csv")
...
def train_npk_leaf_model():
    normal_leaf_data = pd.read_csv("D:/leafimages/NPK_leaf_features.csv")
...
def train_pk_leaf_model():
    normal_leaf_data = pd.read_csv("D:/leafimages/PK_leaf_features.csv")
